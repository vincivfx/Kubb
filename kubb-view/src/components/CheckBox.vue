...
<template>
  <div class="mv-2">
    <input style="display: none" v-model="currentValue" type="checkbox" />
    <button type="button" :class="['btn checkbox', {'checkbox-active': currentValue}]" class="btn-checkbox" @click="switchValue">
